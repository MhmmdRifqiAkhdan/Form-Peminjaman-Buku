...
public class TB02PBOPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "TB02PBO";
	...
	private TB02PBOPersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new TB02PBOPersistentManager();
		}
